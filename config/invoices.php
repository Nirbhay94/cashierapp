...
return [
  ...
  'logo' => env('INVOICE_LOGO', 'http://i.imgur.com/t9G3rFM.png'),
  ...
  */
  ...
  'business_details' => [
      ...
      'id'          => env('COMPANY_ID', '1234567890'),
      'phone'       => env('COMPANY_PHONE', '+34 123 456 789'),
      'location'    => env('COMPANY_LOCATION', 'Main Street 1st'),
      'zip'         => env('COMPANY_ZIP','08241'),
      'city'        => env('COMPANY_CITY', 'Barcelona'),
      'country'     => env('COMPANY_COUNTRY', 'Spain'),
  ],
  ...
  */
  ...
  'footnote' => env('INVOICE_FOOT_NOTE', ''),
