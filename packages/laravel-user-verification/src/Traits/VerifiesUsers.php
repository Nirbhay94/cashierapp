...
trait VerifiesUsers
{
    ...
    public function getVerification(Request $request, $token)
    {
        ...
        try {
            ...
            return redirect($this->redirectIfVerificationFails())
                ->with('error', trans('laravel-user-verification::user-verification.user_not_found_message'));
        } catch (UserIsVerifiedException $e) {
            return redirect($this->redirectIfVerified()
            )->with('success', trans('laravel-user-verification::user-verification.user_is_verified_message'));
        } catch (TokenMismatchException $e) {
            return redirect($this->redirectIfVerificationFails())
                ->with('error', trans('laravel-user-verification::user-verification.token_mismatch_message'));
        }
        ...
        return redirect($this->redirectAfterVerification())
            ->with('success', trans('laravel-user-verification::user-verification.verification_success_message'));
    }
