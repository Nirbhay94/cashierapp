...
class UserVerification
{
     ...
     * @throws \Jrean\UserVerification\Exceptions\ModelNotCompliantException
     */
    public function sendLater($delay, AuthenticatableContract $user, $subject = null, $from = null, $name = null)
    {
        if (! $this->isCompliant($user)) {
            throw new ModelNotCompliantException();
        }
     ...
     * @return mixed
     */
    protected function emailQueueVerificationLink(AuthenticatableContract $user, $subject = null, $from = null, $name = null)
    {
        return $this->mailer->to($user)
     ...
     * @return mixed
     */
    protected function emailLaterVerificationLink($delay, AuthenticatableContract $user, $subject = null, $from = null, $name = null)
    {
        return $this->mailer->to($user)
    ...
    {
        DB::table($user->table)->where('email', $user->email)
            ->update([
    ...
    {
        return $this->hasColumn($user, 'verified') && $this->hasColumn($user, 'verification_token')
            ? true : false;
    }
