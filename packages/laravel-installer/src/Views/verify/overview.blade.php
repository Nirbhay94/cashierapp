@extends('vendor.installer.verify.layouts.master')
...
@section('content')
	...
	<!--  You can switch " data-color="purple" with one of the next bright colors: "green", "orange", "red", "blue" -->
		<div class="wizard-header">
			<h3 class="wizard-title"> {{__('License Validation')}} </h3>
			...
			<div class="tab-pane" id="welcome">
				<div class="row">
					...
					<div class="col-sm-6" style="margin-top: 20px">
						...
						<span>{{__('Please copy your purchase code here and click next to proceed!')}}</span>
					</div>
				</div>
			</div>
		</div>
