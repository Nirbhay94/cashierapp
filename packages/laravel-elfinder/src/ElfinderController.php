...
class ElfinderController extends Controller
{
        ...
        if (empty($roots)) {
            ...
            foreach ($dirs as $dir) {
                $roots[] = [
                    ...
                    'path' => $this->getPrivateDirectory($dir), // path to files (REQUIRED)
                    'URL' => url($this->getPrivateDirectory($dir)), // URL to files (REQUIRED)
    ...
    private function getPrivateDirectory($dir)
    {
        if(Auth::check()){
            $directory = $dir.'/'.strval(Auth::user()->id);
        }else{
            $directory = $dir.'/guests';
        }
