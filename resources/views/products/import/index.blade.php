...
@section('page_title', __('Import Products'))
@push('css')
...
@section('content')
	<div class="block-header">
		<h2>
			...
			<a href="{{route('products.import.sample')}}" class="btn bg-purple waves-effect pull-right">
				{{__('SAMPLE')}}
			</a>
	...
	<div class="callout-block callout-info collapse" id="instructions">
		...
		<div class="content">
			...
			<p><code>name</code>, <code>brand</code>, <code>description</code>, <code>barcode</code>, <code>quantity</code> (required) </p>
			<p><code>barcode_type</code> (required) {{__('This column should contain one of the following (case sensitive):')}} {{implode(', ', get_barcode_types())}}</p>
			<p><code>track</code> (required) {{__('This column should contain one of the following (case sensitive):')}} yes, no</p>
			<p><code>cost</code>, <code>price</code> (price) {{__('This column should contain integer values without a preceding currency.')}}</p>
			<p><code>taxes</code> (optional) {{__('This column should contain only corresponding record id according to the tax table.')}}</p>
			<p><code>product_category_id</code> (required) {{__('This column should contain only corresponding record id according to the products category table.')}}</p>
			<p><code>product_unit_id</code> (required) {{__('This column should contain only corresponding record id according to the products units table.')}}</p>
		</div>
	</div>
