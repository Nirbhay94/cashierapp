...
@section('page_title', __('Tax Configuration'))
@section('content')
			...
			<div class="card">
				<div class="header">
					<div class="box-title">
						<h2>
							{{__('Tax')}}
							<small>{{__('Set all your tax details to be used for invoices and payment.')}}</small>
						</h2>
					</div>
						...
						<div class="form-group row">
							...
							<div class="form-float col-md-9">
								<div class="form-line {{ $errors->has('amount') ? ' error ' : '' }}">
									{!! Form::text('amount', null, array('id' => 'amount', 'class' => 'form-control', 'number' => 'true', 'placeholder' => __('Based on type (amount or %) '), 'required')) !!}
								</div>
							</div>
						</div>
					</div>
                ...
                dataTable = $('#table_data')
                    .on('processing.dt', function (e, settings, processing) {
                        ...
                        "ajax": {
                            "async": true,
                            "type": "POST",
                            "url": '{{route('configuration.tax.data')}}',
                            "data": {}
                        },
                        rowId: 'id',
