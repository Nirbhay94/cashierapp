...
@section('page_title', __('Suppliers List'))
@section('content')
			...
			<div class="card">
				<div class="header">
					<div class="box-title">
						<h2>
							{{__('SUPPLIERS')}}
							<small>{{__('List of suppliers and their transaction activities')}}</small>
						</h2>
					</div>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="table_data">
							...
							<tr>
								...
								<th>{{__('Email')}}</th>
								<th>{{__('Phone')}}</th>
								<th class="none">{{__('GST Number')}}</th>
				...
				<form id="modal-form">
					...
					<div class="modal-body">
						<div class="row clearfix">
								...
								<div class="form-group row">
									...
									<div class="form-float col-md-12">
										<div class="form-line {{ $errors->has('name') ? ' error ' : '' }}">
											{!! Form::text('name', null, array('id' => 'name', 'class' => 'form-control', 'maxlength' => 100, 'placeholder' => __('Suppliers Name'), 'required')) !!}
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="form-float col-md-12">
										<div class="form-line {{ $errors->has('email') ? ' error ' : '' }}">
											{!! Form::email('email', null, array('id' => 'email', 'class' => 'form-control', 'maxlength' => 100, 'placeholder' => __('Suppliers Email (if available)'))) !!}
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="form-float col-md-12">
										<div class="form-line {{ $errors->has('phone_number') ? ' error ' : '' }}">
											{!! Form::text('phone_number', null, array('id' => 'phone_number', 'class' => 'form-control', 'maxlength' => 100, 'placeholder' => __('Suppliers Phone (if available)'))) !!}
										</div>
									</div>
								</div>
								
								<div class="form-group row">
									{!! Form::label('gst_number', __('GST Number'), array('class' => 'col-md-12')); !!}
									<div class="form-float col-md-12">
										<div class="form-line {{ $errors->has('gst_number') ? ' error ' : '' }}">
											{!! Form::text('gst_number', null, array('id' => 'gst_number', 'class' => 'form-control', 'maxlength' => 100)) !!}
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group row">
									{!! Form::label('company', __('Company'), array('class' => 'col-md-12')); !!}
									<div class="form-float col-md-12">
										<div class="form-line {{ $errors->has('company') ? ' error ' : '' }}">
											{!! Form::text('company', null, array('id' => 'company', 'class' => 'form-control', 'maxlength' => 200, 'placeholder' => __('Enter Company'), 'rows' => 3)) !!}
										</div>
									</div>
								</div>
                ...
                dataTable = $('#table_data')
                    .on('processing.dt', function (e, settings, processing) {
                        ...
                        "ajax": {
                            "async": true,
                            "type": "POST",
                            "url": '{{route('people.suppliers.data')}}',
                            "data": {}
                        },
                        rowId: 'id',
